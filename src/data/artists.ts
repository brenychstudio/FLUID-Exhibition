  ...
  },
{
  ...
  shortIntro: {
    ca: "Una obra immersiva sobre la relació fràgil entre la humanitat i la natura",
    es: "Una obra inmersiva sobre el frágil vínculo entre la humanidad y la naturaleza",
    en: "An immersive work on the fragile bond between humanity and nature",
  },
  description: {
    ca: "Whisper of the Sea és una obra multimèdia immersiva de Concept2048 que explora la fràgil relació de la humanitat amb la natura. Els mítics AquaSouls — testimonis silenciosos de la memòria ancestral de l’oceà i portadors d’una saviesa oblidada — emergeixen a la riba a la recerca d’empatia i, a través d’una dansa serena, assenyalen aquesta ruptura, evocant una advertència velada: el passat mai no desapareix del tot, i les aigües poden tornar a alçar-se, com ja va passar abans.\n\nWhisper of the Sea convida a aturar-se i escoltar — no només el mar, sinó també la consciència que uneix tots els éssers vius. En aquest moment delicat, apareix una consciència més profunda — només per a aquells que desitgen escoltar.",
  ...
  },
  {
    ...
    description: {
      ca: "A “Echo” es desprèn la visió comuna de dos artistes amb tècniques diferents: d’una banda, una explosió de massa de paper artesanal treballat i aplicat aleatòriament a la paret, i de l’altra, una explosió de ceràmica i pa d’or. Igual que l’eco del so, l’obra presenta una doble direccionalitat: l’anada i la tornada cap a l’escultura blanca, que suggereix alhora la flora (llavor) i la fauna (llebre) de la natura.",
      es: "En “Echo” se desprende la visión común de dos artistas con técnicas diferentes: por una parte explosión de masa de papel artesanal trabajado y aplicado aleatoriamente a la pared y explosión de cerámica y pan de oro. Al igual que el eco de sonido, la obra presenta doble direccionalidad: la ida y la vuelta hacia la escultura blanca, que desprende un guiño a la flora (semilla) y a la fauna (liebre) de la naturaleza.",
      en: "In “Echo”, a shared vision emerges between two artists working with different techniques: on one side, an explosion of handmade paper pulp worked and randomly applied to the wall, and on the other, an explosion of ceramic and gold leaf. Like the echo of sound, the work presents a double directionality: the movement outward and back toward the white sculpture, which alludes both to flora (seed) and fauna (hare) within nature.",
    },
    heroImage: posterFallback,
